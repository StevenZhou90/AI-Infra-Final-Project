    ...
    *,
    ...
    return compact_metrics(
        evaluate_pattern_drafter(
            ...
            defer_correction_token=bool(config.get("defer_correction_token", False)),
...
def run_pattern_sweep(
    ...
    *,
    ...
    defer_correction_token_values: list[bool],
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default="false",
        help="true, false, or both. Model rejected correction tokens as pending tokens folded into the next verify pass.",
    )
    parser.add_argument(
        "--dynamic-lookahead",
        default="false",
...
def main() -> int:
    ...
    summary = run_pattern_sweep(
        ...
        defer_correction_token_values=parse_bool_modes(args.defer_correction_token),
